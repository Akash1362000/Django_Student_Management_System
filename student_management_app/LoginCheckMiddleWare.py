    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        if user.is_authenticated:
            if user.user_type == "1":
                ...
                if (
                    modulename == "student_management_app.StaffViews"
                    or modulename == "student_management_app.EditResultVIewClass"
                ):
                    pass
                elif (
                    modulename == "student_management_app.views"
                ...
                if (
                    modulename == "student_management_app.StudentViews"
                    or modulename == "django.views.static"
                ):
                    pass
            ...
            if (
                ...
                or modulename == "django.contrib.admin.sites"
                or modulename == "student_management_app.views"
            ):
                pass
            else:
                return HttpResponseRedirect(reverse("show_login"))
